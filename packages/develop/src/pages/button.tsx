    ...
    return (
        <Container>
            <View horizontal wrap gap={16}>
                ...
                <Button text='button' face='outlined' color='info' />
                ...
                <Button text='button' face='outlined' color='gray' />
            ...
            <View horizontal wrap gap={16}>
                ...
                <Button text='button' size={72} radius={12} color='info' />
                ...
                <Button text='button' size={72} radius={12} face='outlined' color='info' />
            ...
            <View horizontal wrap gap={16}>
                ...
                <Button text='button' secondaryText='second line text' color='info' />
                ...
                <Button text='button' secondaryText='second line text' face='outlined' color='info' />
            ...
            <View horizontal wrap gap={16}>
                ...
                <Button text='button' secondaryText='second line text' size={72} radius={24} color='info' />
                ...
                <Button text='button' secondaryText='second line text second line text second line text second line text second line text ' size={72} radius={24} face='outlined' color='primary' />
                <Button text='button' secondaryText='second line text' size={72} radius={24} face='outlined' color='success' />
                <Button text='button' secondaryText='second line text' size={72} radius={24} face='outlined' color='info' />
                <Button text='button' secondaryText='second line text' size={72} radius={24} face='outlined' color='warn' />
                <Button text='button' secondaryText='second line text' size={72} radius={24} face='outlined' color='error' />
                <Button text='button' secondaryText='second line text' size={72} radius={24} face='outlined' color='error' disabled />
            </View>
            <View horizontal wrap gap={16}>
                <IconButton icon={'Menu'} />
                <IconButton size={144} icon={'Menu'} />
                <IconButton size={144} color='error' radius={12} icon={'Menu'} />
            </View>
        </Container>
    )
}
