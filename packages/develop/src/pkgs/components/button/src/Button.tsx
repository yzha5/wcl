...
export default function Button({ text, secondaryText, styles, className, onMouseDown, ...rest }: ButtonProps) {
    ...
    return (
        ...
        >
            <div className='wdkx-button-content' style={styles?.content}>
                ...
                {secondaryText && <div className='wdkx-button-content-secondary-text'>{secondaryText}</div>}
            </div>
        </StyledButton>
    )
}
