...
<path d="M10 9.5V11.5" stroke={color} strokeLinejoin="round"/>
<path d="M10 12.5V14.5" stroke={color} strokeLinejoin="round"/>
<path d="M7 9.5V11.5" stroke={color} strokeLinejoin="round"/>
<path d="M7 12.5V14.5" stroke={color} strokeLinejoin="round"/>
</svg>)}
